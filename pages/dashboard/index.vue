          ...
          >
                  ...
                  >
                    ...
                    <v-list-item-content>
                      <v-list-item-title class="btn-text-color">
                        <span class="tw-text-xl">{{ item.name }}</span>
                      </v-list-item-title>
                    </v-list-item-content>
                  </v-list-item>
                </v-list-item-group>
            ...
            >
              ...
              <div class="d-flex flex-row">
                <div>
                  <v-col align="center">
                    <v-subtitle class="subtitle-text">Rank</v-subtitle>

                    <v-img height="160px" class="my-3" src="/rank/diamond.png">
                    </v-img>
                ...
                <div>
                  ...
                  <DashboardRankReward :column="true" />

                </div>
              </div>

              <div class="paper-overlay mx-5 d-flex align-center">
                <v-col cols="3" align="center" align-self="start">
                    <v-subtitle class="subtitle-text">Rank</v-subtitle>

                    <v-img height="120px" contain class="my-1" src="/rank/ruby.png">
                    </v-img>
                  ...
                  <v-col align="start" align-self="start">
                     <v-subtitle class="subtitle-text">Condition</v-subtitle>

                     <div class="my-1">
                       <ul class="tw-text-base custom-font-2 tw-lowercase btn-text-color">
                         <li class="custom-font-2">7 branches, each branch min 100.000 USDT</li>
                         <li class="custom-font-2">Total spent of all branches is 1.000.000 USDT</li>
                       </ul>
